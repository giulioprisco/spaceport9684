// This terrain is based on the terrain in Mythos, by Croquet.
// https://github.com/croquet/mythos
// New land, water and live grass are generated procedurally as needed.
// See credits in Mythos.
// The code below is the same as in Mythos with some parameters changed.
// The height map is a gradient descending from the middle with some noise added (whirl filter in Gimp).
// This demo works better when viewed in first person.
...
//this.fogDist = this.scaleHill*this.grassPatchRadius * 20.0;
 ...
 //var BEACH_TRANSITION_HIGH = 0.36;
            var BEACH_TRANSITION_LOW = 0.40;
            var BEACH_TRANSITION_HIGH = 0.45;
